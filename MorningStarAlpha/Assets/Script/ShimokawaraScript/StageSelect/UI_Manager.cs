...
public class UI_Manager : MonoBehaviour
{
    ...
    [SerializeField] public GameObject Coin2;
    [SerializeField] public GameObject Coin3;
    ...
    public RectTransform rectCoin1;
    public RectTransform rectCoin2;
    public RectTransform rectCoin3;
    ...
    void Start()
    {
        ...
        rectCoin1 = Coin1.GetComponent<RectTransform>(); transform.GetComponent<RectTransform>();
        rectCoin2 = Coin2.GetComponent<RectTransform>(); transform.GetComponent<RectTransform>();
        rectCoin3 = Coin3.GetComponent<RectTransform>(); transform.GetComponent<RectTransform>();
    ...
    void SetPosition()
    {
        {
            Vector3 TempPos;
            TempPos = new Vector3(CANVAS_WIDTH / 2 - (rectS_RankTime.rect.width / 2), CANVAS_HEIGHT / 2 - (rectS_RankTime.rect.height / 2), 0);
