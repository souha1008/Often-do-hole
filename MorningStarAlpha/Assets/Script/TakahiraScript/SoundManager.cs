...
public class SoundManager : SingletonMonoBehaviour<SoundManager>
{
    ...
    ///<para> 音の再生                                                              </para>
    ///<para>=====================================================================  </para>
    ///<para>第一引数：サウンドのデータ名　(例) Sound1.wav　→　Sound1              </para>
    ///<para>                                                                       </para>
    ///<para>第二引数：音量(0.0f～1.0f) ※音源個別に音量変えられます                </para>
    ///<para>                                                                       </para>
    ///<para>第三引数：音の再生時間指定(再生時間を超えた場合 0.0f)                  </para>
    ///<para>                                                                       </para>
    ///<para>第四引数：音の再生オブジェクト(指定しない場合2D,した場合3D)            </para>
    ///<para>                                                                       </para>
    ///<para>第五引数：音の反響設定(AudioReverbPreset.○○○で指定出来る)           </para>
    ///<para>                                                                       </para>
    ///<para>第六引数～：再生時の音のフェード機能(引数はSoundFade参照)              </para>
    ///<para>                                                                       </para>
    ///<para> ※いくつかオーバーロードした為、使いたい引数だけ使う事も可能          </para>
    ///<para>=====================================================================  </para>
    ///</summary>
    ...
    /// <summary>
    ///<para>再生中の音量調節(内部処理で使える用)</para>
    /// 
    ///<para>音量(0.0f～1.0f)※再生開始時の音量とは別に設定化</para>
    /// </summary>
    ...
    ///<summary>
    ///<para>=====================================================================  </para>
    ///<para>音のフェード機能(再生中の音)        </para>
    ///<para>=====================================================================  </para>
    ///<para>第一引数：フェードする音のデータ名　(例) Sound1.wav　→　Sound1</para>
    ///<para>第二引数：フェードの種類            </para>
    ///<para>第三引数：フェードする時間          </para>
    ///<para>第四引数：フェード後音のボリューム  </para>
    ///<para>第五引数：フェード後音を止めるか    </para>
    ///<para>=====================================================================  </para>
    ///</summary>
