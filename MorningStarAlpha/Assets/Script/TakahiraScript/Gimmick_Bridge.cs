...
public class Gimmick_Bridge : Gimmick_Main
{
    ...
    public override void Init()
    {
        ...
        Vector3 RotatePos = new Vector3(ThisPos.x, ThisPos.y, ThisPos.z + this.gameObject.transform.lossyScale.z * 0.5f); // 回転基準座標
    ...
    private void Rotate()
    {
        ...
        Vector3 RotatePos = new Vector3(StartPos.x, StartPos.y, StartPos.z + this.gameObject.transform.lossyScale.z * 0.5f); // 回転基準座標
